			...
			<div class="table-responsive col-sm-10">
				...
				<thead>
					...
					<tr>
						...
						<td>${o.orderDate}</td>
						<%
							com.dongshiqi.model.Order o=(com.dongshiqi.model.Order)pageContext.findAttribute("o");
							int userId=o.getCustomerId();
							java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
							com.dongshiqi.dao.UserDao userDao=new com.dongshiqi.dao.UserDao();
						...
						<td class="cart_total">
							<%
								...
								String paymentType=com.dongshiqi.model.Payment.findByPaymentId(con,n);
							%>
