		...
		<input type="checkbox" class="checkbox" name="remember" value="1" <%="1".equals(rememberMe)? "checked":""%>/> Keep me signed in
            ...
            <div class="col-sm-4">
                <div class="signup-form"><!--sign up form-->
                    ...
                    <form method="post" action="/2019211001000704DongShiqi_war_exploded/register">
                        ...
                        <input type="radio" style="width: 15px; height: 15px;   display: inline;" name="sex" value="Female"/>&nbsp;Female</span>
                        <span></span>
